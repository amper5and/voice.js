...
/*
// This is the mobile way of getting contacts, but the returned data is not as good as with the _xpc method
exports.Client.prototype.getContacts = function(callback){
	callback = callback || noop;
	this._request('_mobileRequest',{
		query: { 
			m: 'gp', 
			v: 10, 
		},
...
module.exports = {
	...
	*/
	...
	getBlockedMessage: { //get the message that will be played to blocked callers
