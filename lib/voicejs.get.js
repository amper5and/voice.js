...
DEFAULTS.labels.forEach(function(label){
	module.exports[label] = {
		...
		options: {
			...
			start: { demand: false, type: [Number], name: 'o', default: 0, handler: function(start){
			...
			limit: { demand: false, type: [Number], name: 'lm', default: 20, handler: function(limit){
				return limit > 0 ? {lm: limit} : new GoogleVoiceError('INVALID_PARAMETER_VALUE', {parameter: 'limit', value: limit, expected: 'NUMBER GREATER THAN ZERO'});
			}}
		}
	};	
});
...
module.exports.audio = {
	...
	options: {
		...
		type: {submit: false, demand: true, type:[String], match: ['mp3', 'ogg']}
	},
